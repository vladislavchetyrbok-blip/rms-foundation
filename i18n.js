...
const TRANSLATIONS = {
  uk: {
    ...
    camp_filter_all: '🔥 Всі збори',
    camp_filter_drones: '🛸 Дрони та РЕБ',
    camp_filter_med: '🏥 Тактична медицина',
    camp_filter_auto: '🚗 Автотранспорт',
    copied: '✅ Скопійовано!',
    copy_hint: 'Натисніть, щоб скопіювати номер',
    qr_title: '📱 Швидкий донат через QR',
    qr_desc: 'Наведіть камеру смартфона, щоб відкрити офіційну Банку за 3 секунди',
    ...
    gallery_badge: '📸 ЖИВА ХРОНІКА ДОПОМОГИ',
    gallery_title: 'Реальні справи нашого фонду',
    gallery_subtitle: 'Щоденна праця наших волонтерів у лікарнях, прифронтових громадах та на складах. Листайте вбік або натисніть «Показати всі».',
    gallery_btn_all: '📂 Показати всі фотографії ➔',
    gallery_card_all_title: 'Показати всі фото',
    gallery_card_all_desc: 'Відкрити повний архів фотозвітів на окремій сторінці',
    gallery_card_all_btn: 'Відкрити весь архів ➔',
    ...
    modal_tab_crypto: '🪙 Crypto (USDT / BTC)',
        modal_tab_qr: '📱 QR-Донат',
    map_badge: '🗺️ ЖИВА МАПА ДОПОМОГИ',
    map_title: 'Географія нашої присутності',
    map_subtitle: 'Оберіть прифронтовий регіон, щоб побачити детальний звіт переданого обладнання та підтримки.',
    map_drones: '🛸 Дрони / РЕБ:',
    map_med: '🏥 Тактична медицина:',
    map_auto: '🚗 Транспорт / Логістика:',
    radar_badge: '🎯 РАДАР ПОТРЕБ ПЕРЕДОВОЇ',
    radar_title: 'Верифіковані запити від бригад',
    radar_subtitle: 'Прямий зв\'язок з військовими підрозділами та шпиталями. Оберіть конкретний запит та допоможіть його закрити.',
    radar_btn: '⚡ Закрити запит',
    patron_badge: '🏆 КЛУБ ПОСТІЙНИХ МЕЦЕНАТІВ',
    patron_title: 'Щомісячна підписка на Перемогу',
    patron_subtitle: 'Регулярні внески дозволяють фонду планувати закупівлі дронів та аптечок заздалегідь. Оберіть свій Щит підтримки!',
    patron_btn: '🤝 Оформити підписку',
    cert_badge: '📜 ВІРАЛЬНИЙ СЕРТИФІКАТ',
    cert_title: 'Генератор Сертифіката Благодійника',
    cert_subtitle: 'Введіть своє ім\'я або назву компанії, згенеруйте офіційний іменний документ та поділіться ним у соцмережах!',
    cert_name_lbl: 'Ваше ім\'я або назва компанії:',
    cert_name_placeholder: 'напр. Олександр або ТОВ «Інновації»',
    cert_tier_lbl: 'Оберіть звання / статус підтримки:',
    cert_tier_1: '🛡️ Захисник Неба (Дрони та РЕБ)',
    cert_tier_2: '🏥 Ангел Медицини (Тактична медицина)',
    cert_tier_3: '🌟 Почесний Меценат фонду',
    cert_btn_gen: '⚡ Згенерувати Сертифікат',
    cert_btn_dl: '💾 Завантажити PNG',
  ...
  en: {
    ...
    camp_filter_all: '🔥 All Campaigns',
    camp_filter_drones: '🛸 Drones & EW',
    camp_filter_med: '🏥 Tactical Med',
    camp_filter_auto: '🚗 Vehicles & Fuel',
    copied: '✅ Copied!',
    copy_hint: 'Click to copy card number',
    qr_title: '📱 Quick QR Donate',
    qr_desc: 'Scan with your phone camera to open Monobank Jar in 3 seconds',
    ...
    gallery_badge: '📸 LIVE HELP CHRONICLE',
    gallery_title: 'Real deeds of our foundation',
    gallery_subtitle: 'Daily work of our volunteers in hospitals, frontline communities, and warehouses. Swipe sideways or click "Show All".',
    gallery_btn_all: '📂 Show all photos ➔',
    gallery_card_all_title: 'Show all photos',
    gallery_card_all_desc: 'Open full archive of photo reports on a separate page',
    gallery_card_all_btn: 'Open full archive ➔',
    ...
    modal_tab_crypto: '🪙 Crypto (USDT / BTC)',
        modal_tab_qr: '📱 QR-Donate',
    map_badge: '🗺️ LIVE IMPACT MAP',
    map_title: 'Geography of our impact',
    map_subtitle: 'Select a frontline region to see a detailed report of delivered equipment and aid.',
    map_drones: '🛸 Drones / EW:',
    map_med: '🏥 Tactical Med:',
    map_auto: '🚗 Vehicles / Logistics:',
    radar_badge: '🎯 FRONTLINE NEEDS RADAR',
    radar_title: 'Verified requests from brigades',
    radar_subtitle: 'Direct connection with military units and hospitals. Choose a request and help close it.',
    radar_btn: '⚡ Fund Request',
    patron_badge: '🏆 MONTHLY PATRON CLUB',
    patron_title: 'Monthly subscription for Victory',
    patron_subtitle: 'Regular donations allow the foundation to plan drone and medical purchases in advance. Choose your Shield!',
    patron_btn: '🤝 Subscribe Now',
    cert_badge: '📜 OFFICIAL CERTIFICATE',
    cert_title: 'Donor Certificate Generator',
    cert_subtitle: 'Enter your name or company, generate an official document, and share it on social media!',
    cert_name_lbl: 'Your name or company:',
    cert_name_placeholder: 'e.g. Oleksandr or Innovation LLC',
    cert_tier_lbl: 'Choose title / support tier:',
    cert_tier_1: '🛡️ Sky Defender (Drones & EW)',
    cert_tier_2: '🏥 Medical Angel (Tactical Med)',
    cert_tier_3: '🌟 Honorary Patron of Foundation',
    cert_btn_gen: '⚡ Generate Certificate',
    cert_btn_dl: '💾 Download PNG',
  ...
  pl: {
    ...
    hero_cta_gallery: 'Archiwum działań',
    ...
    camp_filter_all: '🔥 Wszystkie zbiórki',
    camp_filter_drones: '🛸 Drony i WRE',
    camp_filter_med: '🏥 Medycyna taktyczna',
    camp_filter_auto: '🚗 Pojazdy i paliwo',
    copied: '✅ Skopiowano!',
    copy_hint: 'Kliknij, aby skopiować numer',
    qr_title: '📱 Szybka wpłata QR',
    qr_desc: 'Zeskanuj aparatem, aby otworzyć puszkę Monobank w 3 sekundy',
    ...
    gallery_badge: '📸 KRONIKA POMOCY NA ŻYWO',
    gallery_title: 'Realne działania naszej fundacji',
    gallery_subtitle: 'Codzienna praca naszych wolontariuszy w szpitalach, społecznościach przyfrontowych i magazynach. Przesuń w bok lub kliknij „Pokaż wszystkie”.',
    gallery_btn_all: '📂 Pokaż wszystkie zdjęcia ➔',
    gallery_card_all_title: 'Pokaż wszystkie zdjęcia',
    gallery_card_all_desc: 'Otwórz pełne archiwum raportów na osobnej stronie',
    gallery_card_all_btn: 'Otwórz całe archiwum ➔',
    ...
    modal_tab_crypto: '🪙 Krypto (USDT / BTC)',
        modal_tab_qr: '📱 QR-Darowizna',
    map_badge: '🗺️ MAPA POMOCY',
    map_title: 'Geografia naszej obecności',
    map_subtitle: 'Wybierz region, aby zobaczyć szczegółowy raport dostarczonego sprzętu i wsparcia.',
    map_drones: '🛸 Drony / WRE:',
    map_med: '🏥 Medycyna:',
    map_auto: '🚗 Pojazdy / Logistyka:',
    radar_badge: '🎯 RADAR POTRZEB',
    radar_title: 'Zweryfikowane wnioski brygad',
    radar_subtitle: 'Bezpośredni kontakt z jednostkami wojskowymi i szpitalami. Wybierz wniosek i pomóż go zamknąć.',
    radar_btn: '⚡ Wesprzeć wniosek',
    patron_badge: '🏆 KLUB PATRONÓW',
    patron_title: 'Miesięczna subskrypcja na Zwycięstwo',
    patron_subtitle: 'Regularne wpłaty pozwalają fundacji planować zakupy z wyprzedzeniem. Wybierz swoją Tarczę!',
    patron_btn: '🤝 Subskrybuj',
    cert_badge: '📜 CERTYFIKAT DARCZYŃCY',
    cert_title: 'Generator Certyfikatu Darczyńcy',
    cert_subtitle: 'Wpisz imię lub nazwę firmy, wygeneruj oficjalny dokument i udostępnij w mediach społecznościowych!',
    cert_name_lbl: 'Twoje imię lub nazwa firmy:',
    cert_name_placeholder: 'np. Aleksander lub Innowacje Sp. z o.o.',
    cert_tier_lbl: 'Wybierz tytuł / status wsparcia:',
    cert_tier_1: '🛡️ Obrońca Nieba (Drony i WRE)',
    cert_tier_2: '🏥 Anioł Medycyny (Medycyna)',
    cert_tier_3: '🌟 Honorowy Patron Fundacji',
    cert_btn_gen: '⚡ Wygeneruj certyfikat',
    cert_btn_dl: '💾 Pobierz PNG',
  ...
  ro: {
    ...
    hero_cta_gallery: 'Arhiva activităților',
    ...
    camp_filter_all: '🔥 Toate campaniile',
    camp_filter_drones: '🛸 Drone și EW',
    camp_filter_med: '🏥 Medicină tactică',
    camp_filter_auto: '🚗 Vehicule și combustibil',
    copied: '✅ Copiat!',
    copy_hint: 'Faceți clic pentru a copia numărul',
    qr_title: '📱 Donează prin QR',
    qr_desc: 'Scanați cu camera pentru a deschide Monobank în 3 secunde',
    ...
    gallery_badge: '📸 CRONICA AJUTORULUI IN TIMP REAL',
    gallery_title: 'Faptele reale ale fundației noastre',
    gallery_subtitle: 'Munca zilnică a voluntarilor noștri în spitale, comunități din linia întâi și depozite. Glisați lateral sau faceți clic pe „Arată tot”.',
    gallery_btn_all: '📂 Arată toate fotografiile ➔',
    gallery_card_all_title: 'Arată toate fotografiile',
    gallery_card_all_desc: 'Deschideți arhiva completă a rapoartelor pe o pagină separată',
    gallery_card_all_btn: 'Deschide arhiva ➔',
    ...
    modal_tab_crypto: '🪙 Crypto (USDT / BTC)',
        modal_tab_qr: '📱 Donație QR',
    map_badge: '🗺️ HARTA AJUTORULUI',
    map_title: 'Geografia prezenței noastre',
    map_subtitle: 'Selectați o regiune pentru a vedea raportul detaliat al echipamentelor și ajutorului livrat.',
    map_drones: '🛸 Drone / EW:',
    map_med: '🏥 Medicină:',
    map_auto: '🚗 Vehicule / Logistică:',
    radar_badge: '🎯 RADAR DE NEVOI',
    radar_title: 'Cereri verificate de la brigăzi',
    radar_subtitle: 'Conexiune directă cu unitățile militare și spitalele. Alegeți o cerere și ajutați la închiderea ei.',
    radar_btn: '⚡ Finanțează cererea',
    patron_badge: '🏆 CLUBUL PATRONILOR',
    patron_title: 'Abonament lunar pentru Victorie',
    patron_subtitle: 'Donațiile regulate permit planificarea achizițiilor de drone și kituri medicale în avans. Alegeți Scutul!',
    patron_btn: '🤝 Abonează-te',
    cert_badge: '📜 CERTIFICAT OFICIAL',
    cert_title: 'Generator de Certificate',
    cert_subtitle: 'Introduceți numele sau compania, generați un document oficial și distribuiți pe rețelele sociale!',
    cert_name_lbl: 'Numele sau compania:',
    cert_name_placeholder: 'ex. Alexandru sau Inovație SRL',
    cert_tier_lbl: 'Alegeți titlul / statutul:',
    cert_tier_1: '🛡️ Apărătorul Cerului (Drone & EW)',
    cert_tier_2: '🏥 Îngerul Medicinei (Medicină)',
    cert_tier_3: '🌟 Patron de Onoare al Fundației',
    cert_btn_gen: '⚡ Generează Certificatul',
    cert_btn_dl: '💾 Descarcă PNG',
  ...
  it: {
    ...
    nav_gallery: 'Reportage Fotografici',
    ...
    hero_cta_gallery: 'Archivio attività',
    ...
    camp_filter_all: '🔥 Tutte le campagne',
    camp_filter_drones: '🛸 Droni ed EW',
    camp_filter_med: '🏥 Medicina tattica',
    camp_filter_auto: '🚗 Veicoli e carburante',
    copied: '✅ Copiato!',
    copy_hint: 'Clicca per copiare il numero',
    qr_title: '📱 Donazione QR veloce',
    qr_desc: 'Scansiona con la fotocamera per aprire Monobank in 3 secondi',
    ...
    gallery_badge: '📸 CRONACA DAL VIVO DELL\'AIUTO',
    gallery_title: 'Le reali attività della nostra fondazione',
    gallery_subtitle: 'Lavoro quotidiano dei nostri volontari negli ospedali, nelle comunità in prima linea e nei magazzini. Scorri lateralmente o clicca su "Mostra tutto".',
    gallery_btn_all: '📂 Mostra tutte le foto ➔',
    gallery_card_all_title: 'Mostra tutte le foto',
    gallery_card_all_desc: 'Apri l\'archivio completo dei reportage su una pagina separata',
    gallery_card_all_btn: 'Apri tutto l\'archivio ➔',
    ...
    modal_tab_crypto: '🪙 Criptovalute (USDT / BTC)',
        modal_tab_qr: '📱 Donazione QR',
    map_badge: '🗺️ MAPPA DELL\'AIUTO',
    map_title: 'Geografia della nostra presenza',
    map_subtitle: 'Seleziona una regione per vedere il report dettagliato delle attrezzature e degli aiuti consegnati.',
    map_drones: '🛸 Droni / EW:',
    map_med: '🏥 Medicina:',
    map_auto: '🚗 Veicoli / Logistica:',
    radar_badge: '🎯 RADAR BISOGNI',
    radar_title: 'Richieste verificate dalle brigate',
    radar_subtitle: 'Connessione diretta con le unità militari e gli ospedali. Scegli una richiesta e aiuta a chiuderla.',
    radar_btn: '⚡ Supporta richiesta',
    patron_badge: '🏆 CLUB DEI MECENATI',
    patron_title: 'Abbonamento mensile per la Vittoria',
    patron_subtitle: 'Le donazioni regolari consentono di pianificare in anticipo gli acquisti. Scegli il tuo Scudo!',
    patron_btn: '🤝 Abbonati ora',
    cert_badge: '📜 CERTIFICATO UFFICIALE',
    cert_title: 'Generatore di Certificati',
    cert_subtitle: 'Inserisci il tuo nome o azienda, genera un documento ufficiale e condividilo sui social network!',
    cert_name_lbl: 'Il tuo nome o azienda:',
    cert_name_placeholder: 'es. Alessandro o Innovazione Srl',
    cert_tier_lbl: 'Scegli il titolo / status:',
    cert_tier_1: '🛡️ Difensore del Cielo (Droni & EW)',
    cert_tier_2: '🏥 Angelo della Medicina (Medicina)',
    cert_tier_3: '🌟 Mecenate d\'Onore',
    cert_btn_gen: '⚡ Genera Certificato',
    cert_btn_dl: '💾 Scarica PNG',
  ...
  de: {
    ...
    hero_cta_gallery: 'Aktivitätsarchiv',
    ...
    camp_filter_all: '🔥 Alle Spendenaktionen',
    camp_filter_drones: '🛸 Drohnen & EloKa',
    camp_filter_med: '🏥 Taktische Medizin',
    camp_filter_auto: '🚗 Fahrzeuge & Treibstoff',
    copied: '✅ Kopiert!',
    copy_hint: 'Klicken zum Kopieren der Nummer',
    qr_title: '📱 Schnelle QR-Spende',
    qr_desc: 'Mit Handykamera scannen, um Monobank in 3 Sekunden zu öffnen',
    ...
    gallery_badge: '📸 LIVE-HILFSCHRONIK',
    gallery_title: 'Reale Taten unserer Stiftung',
    gallery_subtitle: 'Tägliche Arbeit unserer Freiwilligen in Krankenhäusern, Gemeinden an der Front und Lagern. Wischen Sie zur Seite oder klicken Sie auf „Alle anzeigen“.',
    gallery_btn_all: '📂 Alle Fotos anzeigen ➔',
    gallery_card_all_title: 'Alle Fotos anzeigen',
    gallery_card_all_desc: 'Vollständiges Archiv der Fotoberichte auf separater Seite öffnen',
    gallery_card_all_btn: 'Gesamtes Archiv öffnen ➔',
    ...
    modal_tab_crypto: '🪙 Krypto (USDT / BTC)',
        modal_tab_qr: '📱 QR-Spende',
    map_badge: '🗺️ HILFSMAPPE',
    map_title: 'Geografie unserer Hilfe',
    map_subtitle: 'Wählen Sie eine Region aus, um den detaillierten Bericht der gelieferten Ausrüstung zu sehen.',
    map_drones: '🛸 Drohnen / EloKa:',
    map_med: '🏥 Medizin:',
    map_auto: '🚗 Fahrzeuge / Logistik:',
    radar_badge: '🎯 FRONT-BEDARFSRADAR',
    radar_title: 'Verifizierte Anfragen von Brigaden',
    radar_subtitle: 'Direkter Draht zu militärischen Einheiten und Krankenhäusern. Wählen Sie eine Anfrage und helfen Sie.',
    radar_btn: '⚡ Anfrage unterstützen',
    patron_badge: '🏆 PATRON-KLUB',
    patron_title: 'Monatliches Abo für den Sieg',
    patron_subtitle: 'Regelmäßige Spenden ermöglichen die rechtzeitige Planung von Drohnen- und Medizinprodukten. Wählen Sie Ihr Schild!',
    patron_btn: '🤝 Jetzt abonnieren',
    cert_badge: '📜 OFFIZIELLES ZERTIFIKAT',
    cert_title: 'Spender-Zertifikatsgenerator',
    cert_subtitle: 'Namen oder Firma eingeben, offizielles Dokument generieren und in sozialen Netzwerken teilen!',
    cert_name_lbl: 'Ihr Name oder Firma:',
    cert_name_placeholder: 'z.B. Alexander oder Innovation GmbH',
    cert_tier_lbl: 'Titel / Status auswählen:',
    cert_tier_1: '🛡️ Himmelsverteidiger (Drohnen & EloKa)',
    cert_tier_2: '🏥 Medizinischer Engel (Medizin)',
    cert_tier_3: '🌟 Ehrenpatron der Stiftung',
    cert_btn_gen: '⚡ Zertifikat generieren',
    cert_btn_dl: '💾 PNG herunterladen',
