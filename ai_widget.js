...
(function() {
  ...
  topBar.innerHTML = `
    ...
    <div style="display: flex; align-items: center; gap: 12px;">
      ...
      <button id="rmsMegaMenuBtn">
        <span>🚀 ВСІ КАТЕГОРІЇ ТА МОДУЛІ (32+)</span>
    ...
    <div class="mega-modal">
      <div class="mega-header">
        <div>
          ...
          <h2 style="color: #fff; font-size: 1.8rem; font-weight: 900; margin: 0; font-style: italic;">ВСІ 32+ МОДУЛІ ТА РОЗДІЛИ ФОНДУ</h2>
      ...
      <div class="mega-search-wrap">
        ...
        <input type="text" id="megaSearchInput" placeholder="Швидкий пошук по всіх 32+ розділах (напр: дрони, шпиталі, кров, гранти, аукціони, звітність)..." autocomplete="off">
  ...
  const WIDGET_I18N = {
    uk: {
      ...
      top_info: '● 32+ активні напрямки • НБУ та 501(c)(3) верифікація',
      mega_btn: '🚀 ВСІ КАТЕГОРІЇ ТА МОДУЛІ (32+)',
      mega_title: 'ВСІ 32+ МОДУЛІ ТА РОЗДІЛИ ФОНДУ',
    ...
    en: {
      ...
      top_info: '● 32+ active modules • NBU & 501(c)(3) verified',
      mega_btn: '🚀 ALL CATEGORIES & MODULES (32+)',
      mega_title: 'ALL 32+ MODULES & SECTIONS',
    ...
    pl: {
      ...
      top_info: '● 32+ aktywne moduły • Weryfikacja NBU i 501(c)(3)',
      mega_btn: '🚀 WSZYSTKIE KATEGORIE I MODUŁY (32+)',
      mega_title: 'WSZYSTKIE 32+ MODUŁY I DZIAŁY',
    ...
    de: {
      ...
      top_info: '● 32+ aktive Module • NBU- & 501(c)(3)-verifiziert',
      mega_btn: '🚀 ALLE KATEGORIEN & MODULE (32+)',
      mega_title: 'ALLE 32+ MODULE & BEREICHE',
    ...
    ro: {
      ...
      top_info: '● 32+ module active • Verificat NBU și 501(c)(3)',
      mega_btn: '🚀 TOATE CATEGORIILE ȘI MODULELE (32+)',
      mega_title: 'TOATE CELE 32+ MODULE ȘI SECȚIUNI',
    ...
    it: {
      ...
      top_info: '● 32+ moduli attivi • Verificato NBU e 501(c)(3)',
      mega_btn: '🚀 TUTTE LE CATEGORIE E MODULI (32+)',
      mega_title: 'TUTTI I 32+ MODULI E SEZIONI',
