...
(function() {
    ...
    <div class="titan-header">
      <div style="display: flex; align-items: center; gap: 10px;">
        ...
        <div>
          ...
          <span style="color: #10b981; font-size: 0.75rem;">● Онлайн • 100 модулів у пам'яті</span>
        </div>
      </div>
  ...
  window.titanSubmit = function(e) {
    ...
    setTimeout(() => {
      ...
      let reply = "Дякую за звернення! Наша система містить 100 спеціалізованих модулів. Якщо ви хочете зробити донат — перейдіть на сторінку «🤝 Долучитися». Для зв'язку з живим координатором скористайтеся розділом «💬 Підтримка».";
  ...
  topBar.innerHTML = `
    <div style="display: flex; align-items: center; gap: 15px;">
      ...
      <span class="top-info topbar-hide-mob" style="color: #94a3b8;">● 100 активних напрямків • НБУ та 501(c)(3) верифікація</span>
    </div>
    <div style="display: flex; align-items: center; gap: 12px;">
      ...
      <button id="rmsMegaMenuBtn">
        <span>🚀 ВСІ КАТЕГОРІЇ ТА МОДУЛІ (100)</span>
    ...
    <div class="mega-modal">
      <div class="mega-header">
        <div>
          ...
          <h2 style="color: #fff; font-size: 1.8rem; font-weight: 900; margin: 0; font-style: italic;">ВСІ 100 МОДУЛІВ ТА РОЗДІЛІВ ФОНДУ</h2>
      ...
      <div class="mega-search-wrap">
        ...
        <input type="text" id="megaSearchInput" placeholder="Швидкий пошук по всіх 100 розділах (напр: дрони, шпиталі, кров, гранти, аукціони, звітність)..." autocomplete="off">
  ...
  const WIDGET_I18N = {
    uk: {
      ...
      top_info: '● 100 активних напрямків • НБУ та 501(c)(3) верифікація',
      mega_btn: '🚀 ВСІ КАТЕГОРІЇ ТА МОДУЛІ (100)',
      mega_title: 'ВСІ 100 МОДУЛІВ ТА РОЗДІЛІВ ФОНДУ',
    ...
    en: {
      ...
      top_info: '● 100 active modules • NBU & 501(c)(3) verified',
      mega_btn: '🚀 ALL CATEGORIES & MODULES (100)',
      mega_title: 'ALL 100 MODULES & SECTIONS',
    ...
    pl: {
      ...
      top_info: '● 100 aktywne moduły • Weryfikacja NBU i 501(c)(3)',
      mega_btn: '🚀 WSZYSTKIE KATEGORIE I MODUŁY (100)',
      mega_title: 'WSZYSTKIE 100 MODUŁÓW I DZIAŁÓW',
    ...
    de: {
      ...
      top_info: '● 100 aktive Module • NBU- & 501(c)(3)-verifiziert',
      mega_btn: '🚀 ALLE KATEGORIEN & MODULE (100)',
      mega_title: 'ALLE 100 MODULE & BEREICHE',
    ...
    ro: {
      ...
      top_info: '● 100 module active • Verificat NBU și 501(c)(3)',
      mega_btn: '🚀 TOATE CATEGORIILE ȘI MODULELE (100)',
      mega_title: 'TOATE CELE 100 DE MODULE ȘI SECȚIUNI',
    ...
    it: {
      ...
      top_info: '● 100 moduli attivi • Verificato NBU e 501(c)(3)',
      mega_btn: '🚀 TUTTE LE CATEGORIE E MODULI (100)',
      mega_title: 'TUTTI I 100 MODULI E SEZIONI',
